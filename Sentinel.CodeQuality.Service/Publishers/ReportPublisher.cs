...
public class ReportPublisher : IReportPublisher, IDisposable
{
    ...
    public ReportPublisher(IConfiguration configuration, ILogger<ReportPublisher> logger)
    {
        ...
        // Connection is established lazily on first PublishFinalResultAsync call.
        // Removed TryEnsureConnectionAsync().GetAwaiter().GetResult() — sync-over-async deadlock risk.
    }
