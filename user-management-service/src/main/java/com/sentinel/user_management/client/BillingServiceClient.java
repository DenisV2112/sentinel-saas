package com.sentinel.user_management.client;

import com.sentinel.user_management.client.dto.TenantSubscriptionLimitsDTO;
...
public interface BillingServiceClient {
    ...
    /**
     * Fallback: retorna límites restrictivos.
     */
