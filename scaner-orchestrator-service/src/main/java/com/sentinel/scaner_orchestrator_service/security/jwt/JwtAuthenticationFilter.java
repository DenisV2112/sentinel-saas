package com.sentinel.scaner_orchestrator_service.security.jwt;
        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                if (jwtService.isTokenValid(jwt)) {
                    ...
                    List<GrantedAuthority> authorities = (globalRole != null)
                            ? List.of(new SimpleGrantedAuthority(globalRole))
